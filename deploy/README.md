# Nexus Relay Deployment Files

This directory contains files for deploying Nexus Relay on Linux servers.
...
Nexus Relay supports three methods to connect to Gemini:
...
Nexus Relay supports TLS fingerprint simulation to make requests appear as if they come from the official Claude CLI (Node.js client).
