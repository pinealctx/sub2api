...
declare -A MSG_ZH=(
    ...
    # Installation
    ["install_title"]="Nexus Relay 安装脚本"
    ...
    # Completion
    ["install_complete"]="Nexus Relay 安装完成！"
    ["install_dir"]="安装目录"
    ["next_steps"]="后续步骤"
    ["step1_check_services"]="确保 PostgreSQL 和 Redis 正在运行："
    ["step2_start_service"]="启动 Nexus Relay 服务："
    ...
    ["not_installed"]="Nexus Relay 尚未安装，请先执行全新安装"
    ["fresh_install_hint"]="用法"

    # Uninstall
    ["uninstall_confirm"]="这将从系统中移除 Nexus Relay。"
    ...
    ["uninstall_complete"]="Nexus Relay 已卸载"

    # Help
    ["usage"]="用法"
    ["cmd_none"]="(无参数)"
    ["cmd_install"]="安装 Nexus Relay"
    ["cmd_upgrade"]="升级到最新版本"
    ["cmd_uninstall"]="卸载 Nexus Relay"
    ...
    ["server_config_desc"]="配置 Nexus Relay 服务监听地址"
...
declare -A MSG_EN=(
    ...
    # Installation
    ["install_title"]="Nexus Relay Installation Script"
    ...
    # Completion
    ["install_complete"]="Nexus Relay installation completed!"
    ["install_dir"]="Installation directory"
    ["next_steps"]="NEXT STEPS"
    ["step1_check_services"]="Make sure PostgreSQL and Redis are running:"
    ["step2_start_service"]="Start Nexus Relay service:"
    ...
    # Upgrade
    ["upgrading"]="Upgrading Nexus Relay..."
    ...
    ["not_installed"]="Nexus Relay is not installed. Please run a fresh install first"
    ["fresh_install_hint"]="Usage"

    # Uninstall
    ["uninstall_confirm"]="This will remove Nexus Relay from your system."
    ...
    ["uninstall_complete"]="Nexus Relay has been uninstalled"

    # Help
    ["usage"]="Usage"
    ["cmd_none"]="(none)"
    ["cmd_install"]="Install Nexus Relay"
    ["cmd_upgrade"]="Upgrade to the latest version"
    ["cmd_uninstall"]="Remove Nexus Relay"
    ...
    ["server_config_desc"]="Configure Nexus Relay server listen address"
...
# Upgrade function
upgrade() {
    # Check if Nexus Relay is installed
    if [ ! -f "$INSTALL_DIR/sub2api" ]; then
...
# Requires: Nexus Relay must already be installed
install_version() {
