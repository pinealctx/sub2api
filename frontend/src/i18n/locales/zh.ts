export default {  // Home Page
  home: {
    ...
    getStarted: '进入系统',
    goToDashboard: '进入控制台',
    heroSubtitle: '内部统一 AI API 网关',
    heroDescription: '统一鉴权、账号池调度、代理、分组与用量统计。',
    tags: {
      gateway: '统一网关',
      accountPool: '账号池调度',
      usageStats: '用量统计'
    ...
    features: {
      unifiedGateway: '统一接入',
      unifiedGatewayDesc: '一个 API Key 访问团队已授权的 Claude、OpenAI、Gemini 与 Antigravity 能力。',
      multiAccount: '稳定调度',
      multiAccountDesc: '按分组、账号状态、代理与限流规则调度上游账号。',
      usageStats: '透明统计',
      usageStatsDesc: '保留请求、Token、成本和错误记录，便于内部审计与运维。'
    },
    footer: {
      allRightsReserved: '内部使用。'
    }
  },
  ...
  auth: {
    ...
    sessionExpiredDesc: '请返回账号创建流程重新开始。',
    ...
    oidc: {
      ...
      backToLogin: '返回登录',
      invitationRequired: '该 {providerName} 账号尚未创建本地账号，站点已开启邀请码准入，请输入邀请码以完成账号创建。',
      invalidPendingToken: '账号创建凭证已失效，请重新登录。',
      completeAccountCreation: '完成账号创建',
      completing: '正在完成账号创建...',
      completeAccountCreationFailed: '账号创建失败，请检查邀请码后重试。'
    },
  ...
  usage: {
    ...
    errors: {
      ...
      categories: {
        auth: '认证失败', rate_limit: '限流',                                        quota: '配额不足',
  ...
  admin: {
    ...
    users: {
      ...
      setAllowedGroups: '设置允许分组',      allowedGroupsHint: '选择此用户可以使用的分组。',
      ...
      platformOther: '其他',
      allTypes: '全部类型',      typeConcurrency: '并发调整',
    ...
    accounts: {
      ...
      setPrivacy: '设置隐私',      planAbnormal: '异常',
      planExpires: '到期',
      ...
      oauth: {
        ...
        openai: {
          ...
          failedToExchangeCode: 'OpenAI 授权码交换失败',
        ...
        gemini: {
          ...
          projectIdHint:
            '留空则在交换授权码后自动探测；若自动探测失败，可填写后重新生成授权链接再授权。',
          ...
          failedToExchangeCode: 'Gemini 授权码交换失败',
          missingProjectId:
        ...
        antigravity: {
          ...
          missingExchangeParams: '缺少 code / session_id / state',
          failedToExchangeCode: 'Antigravity 授权码交换失败',
          // Refresh Token auth
          refreshTokenAuth: '手动输入 RT',
    ...
    ops: {
      ...
      settings: {
        ...
        ignoreUpstreamCreditErrors: '忽略上游信用不足错误',
        ignoreUpstreamCreditErrorsHint: '启用后，上游返回的信用或额度不足错误将不会写入错误日志。',
        autoRefresh: '自动刷新',
        enableAutoRefresh: '启用自动刷新',
      ...
      tooltips: {
        ...
        sla: '服务等级协议达成率，排除业务限制（如上游额度不足、配额超限）的成功请求占比。',
    ...
    settings: {
      title: '系统设置',
      description: '管理账号创建、邮箱验证、默认值和 SMTP 设置',
      tabs: {
        general: '通用设置',
        agreement: '登录条款',
        features: '功能开关',
      ...
      oidc: {
        ...
        enable: '启用 OIDC 登录',
        enableHint: '在登录/账号创建页面显示 OIDC 登录入口',
      ...
      webSearchEmulation: {
        ...
        quotaResetAnchorAt: '配额重置起点',
        quotaResetAnchorAtHint: '配额从此日期起每月自动重置；留空则不自动重置',
        quotaUsage: '用量',
        resetUsage: '重置',
      ...
      site: {
        ...
        contactInfo: '客服联系方式',
        contactInfoPlaceholder: '例如：QQ: 123456789',        contactInfoHint: '填写内部支持联系方式，将展示在个人资料等位置',
