export default {  // Home Page
  home: {
    ...
    heroSubtitle: 'Internal unified AI API gateway',
    heroDescription: 'Centralized auth, account-pool scheduling, proxying, grouping, and usage analytics.',
    tags: {
    ...
    features: {
      ...
      unifiedGatewayDesc: 'Use one API key for the Claude, OpenAI, Gemini, and Antigravity capabilities your team allows.',
      multiAccount: 'Reliable scheduling',
      multiAccountDesc: 'Route upstream accounts by group, account health, proxy, and rate-limit controls.',
      usageStats: 'Transparent usage',
      usageStatsDesc: 'Keep request, token, cost, and error records for internal audit and operations.'
    },
    footer: {
      allRightsReserved: 'Internal use.'
    }
  },
  ...
  // Setup Wizard
  setup: {
    title: 'Nexus Relay Setup',
    description: 'Configure your Nexus Relay instance',
    database: {
  ...
  auth: {
    ...
    sessionExpiredDesc: 'Please go back to the account creation flow and start again.',
    ...
    oidc: {
      ...
      invitationRequired:
        'This {providerName} account is does not have a local account yet. The site requires an invitation code — please enter one to complete account creation.',
      invalidPendingToken: 'The account creation token has expired. Please sign in again.',
      completeAccountCreation: 'Complete Account Creation',
      completing: 'Completing account creation…',
      completeAccountCreationFailed: 'Account creation failed. Please check your invitation code and try again.'
    },
  ...
  usage: {
    ...
    errors: {
      ...
      categories: {
        auth: 'Auth failed', rate_limit: 'Rate limited',                                                         quota: 'Quota exceeded',
  ...
  admin: {
    ...
    users: {
      ...
      setAllowedGroups: 'Set Allowed Groups',      allowedGroupsHint: 'Select which groups this user can use.',
      ...
      platformOther: 'Other',
      allTypes: 'All Types',      typeConcurrency: 'Concurrency Adjustment',
    ...
    accounts: {
      ...
      setPrivacy: 'Set Privacy',      planAbnormal: 'Abnormal',
      planExpires: 'Expires',
    ...
    ops: {
      ...
      settings: {
        ...
        ignoreUpstreamCreditErrors: 'Ignore Upstream Credit Errors',
        ignoreUpstreamCreditErrorsHint: 'When enabled, upstream credit or quota exhaustion errors will not be written to the error log.',
        autoRefresh: 'Auto Refresh',
        enableAutoRefresh: 'Enable auto refresh',
      ...
      tooltips: {
        ...
        sla: 'Service Level Agreement success rate, excluding business limits (e.g., upstream credit exhaustion, quota exceeded).',
    ...
    settings: {
      ...
      description: 'Manage account creation, email verification, default values, and SMTP settings',
      tabs: {
        general: 'General',
        agreement: 'Agreement',
      ...
      turnstile: {
        ...
        description: 'Bot protection for login and account creation',
      ...
      oidc: {
        ...
        enableHint: 'Show OIDC login on the login page',
      ...
      webSearchEmulation: {
        ...
        quotaResetAnchorAt: 'Quota Reset Anchor',
        quotaResetAnchorAtHint: 'Quota resets monthly from this date; leave empty to disable auto-reset',
        quotaUsage: 'Usage',
        resetUsage: 'Reset',
      ...
      site: {
        ...
        backendModeDescription:
          'Disables public pages and self-service features. Only admin can log in and manage the platform.',
        siteName: 'Site Name',
        ...
        contactInfoPlaceholder: 'e.g., QQ: 123456789',        contactInfoHint: 'Internal support contact info, displayed in profile and related pages',
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to Nexus Relay',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the Nexus Relay AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
