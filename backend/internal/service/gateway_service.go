...
// RecordUsage records usage and updates internal quotas.
...
func (s *GatewayService) initDebugGatewayBodyFile(path string) {
	...
	// #nosec G703 -- path comes from operator-controlled debug configuration.
	...
	if dir := filepath.Dir(path); dir != "." {
		// #nosec G703 -- dir is derived from operator-controlled debug configuration.
