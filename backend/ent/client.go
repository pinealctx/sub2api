...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.APIKey, c.Account, c.AccountGroup, c.AuthIdentity, c.ChannelMonitor,
		c.ChannelMonitorDailyRollup, c.ChannelMonitorHistory,
		c.ChannelMonitorRequestTemplate, c.ErrorPassthroughRule, c.Group,
		c.IdempotencyRecord, c.IdentityAdoptionDecision, c.PendingAuthSession, c.Proxy,
		c.SecuritySecret, c.Setting, c.TLSFingerprintProfile, c.UsageCleanupTask,
		c.UsageLog, c.User, c.UserAllowedGroup, c.UserAttributeDefinition,
		c.UserAttributeValue, c.UserPlatformQuota,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		APIKey, Account, AccountGroup, AuthIdentity, ChannelMonitor,
		...
		UserAttributeDefinition, UserAttributeValue, UserPlatformQuota []ent.Hook
	}
	inters struct {
		APIKey, Account, AccountGroup, AuthIdentity, ChannelMonitor,
		ChannelMonitorDailyRollup, ChannelMonitorHistory,
		...
		IdentityAdoptionDecision, PendingAuthSession, Proxy, SecuritySecret, Setting,
		TLSFingerprintProfile, UsageCleanupTask, UsageLog, User, UserAllowedGroup,
		UserAttributeDefinition, UserAttributeValue,
		UserPlatformQuota []ent.Interceptor
	}
)
